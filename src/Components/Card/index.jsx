    ...
    return (
        ...
        <div className="col" onClick={() => redirecionar && history.push(`/vendedor/${id_vendedor}`)}>
            <div className="card mb-4 shadow-sm">
                <img className="img-fluid" style={{maxHeight:255}} id="imgPlaceholder" src={img === '' ? `${process.env.REACT_APP_API_URL}/uploads/ponto-de-interrogação.jpeg` : img} alt="Imagem do anuncio" />
